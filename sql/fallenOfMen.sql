...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2016 a las 13:49:41
...
CREATE TABLE IF NOT EXISTS `profile` (
  ...
  `idCity` int(11) NOT NULL COMMENT 'foren'
...
CREATE TABLE IF NOT EXISTS `user` (
  `id` int(11) NOT NULL COMMENT 'la primary',
...
--
ALTER TABLE `user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'la primary';
